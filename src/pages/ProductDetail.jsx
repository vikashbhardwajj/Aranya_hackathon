...
const ProductDetail = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{product.name} – Aranya Product Detail</title>
        <meta name="description" content={product.description} />
        <meta
          name="keywords"
          content={`${product.name}, nature product, Aranya`}
        />
        <meta
          property="og:title"
          content={`${product.name} – A Creation of Nature`}
        />
        <meta property="og:description" content={product.description} />
        <meta
          property="og:image"
          content={`https://aranya-five.vercel.app${product.image}`}
        />
        <meta
          property="og:url"
          content={`https://aranya-five.vercel.app/product/${product.id}`}
        />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${product.name} – Aranya`} />
      ...
      <PageWrapper className="product-detail overflow-hidden">
        <div ref={boxRef} className="product_detail_wrapper overflow-hidden">
          <CustomCurosr
            targetRef={boxRef}
          ...
          <div className="page1 h-[30vh] md:h-[50vh]">
            ...
            <div className="content md:gap-[1rem]">
              ...
              <h2 className="z-[45] overflow-hidden rounded-full border px-4 py-1 text-base font-bold uppercase opacity-80">
            ...
            <div className="right flex w-full flex-col justify-between gap-10 md:w-1/2 md:gap-0 md:px-4">
              ...
              <div className="bottom flex flex-col gap-5 md:flex-row md:justify-between">
                ...
                <div className="right_bottom_right">
                  <button
                    className="z-[45] px-4 py-2 text-sm font-bold uppercase opacity-80"
          ...
          <div className="page5 relative flex flex-col gap-6 pb-[1rem] md:flex-row-reverse md:p-[2rem] lg:gap-0">
            <div className="left relative w-full md:w-1/2">
              ...
              <a
                ...
                target="_blank"
                className="cta-2 absolute right-0 bottom-0 z-[45] px-4 py-2 text-sm font-bold uppercase opacity-80"
                style={{ ["--color"]: product.color }}
              >
