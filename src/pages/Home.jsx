    ...
    <PageWrapper className="home overflow-hidden">
      ...
      <div className="home-content overflow-hidden flex w-full flex-col items-center justify-center gap-2">
        <div className="page page1">
          ...
          <h1 className="home-main-text text-[1.5rem] leading-none md:text-[3rem] lg:text-[4rem]">
            <WavyText
              text=" Mother Nature -"
              y={15}
              ...
              <div className="page-2-left sticky top-10 h-fit bg-white/10 shadow-md backdrop-blur-2xl">
                <section className="page2-section relative flex justify-center px-6 py-20 text-gray-800">
                  <div className="max-w-4xl text-start">
                    ...
                    >
                      The wind didn’t need words. The trees swayed, and we felt
                      comfort. The river flowed, and we remembered how to move.
                    </motion.p>
                    ...
                    >
                      ...
                      the rustling leaves — and found peace in what wasn’t said.
                    </motion.p>
                    <motion.blockquote
                      initial={{ opacity: 0 }}
        ...
        <div className="page page3 p-[1rem] md:p-[4rem]">
          ...
          <div className="page3-center flex flex-col justify-between gap-10 border-b py-10 md:flex-row">
            ...
            >
              ...
              <div className="page3-center-left-wrapper flex gap-30 py-5">
                <div className="first">
                  <Link
                    to="/about"
                    className="link cursor-pointer text-base leading-none font-bold tracking-wider uppercase opacity-70 md:text-base"
                  >
                    Origin
                  </Link>
                  <h3 className="text-base leading-none font-bold tracking-wider uppercase opacity-70 md:text-base">
                    Stories
                  </h3>
                  <h3 className="text-base leading-none font-bold tracking-wider uppercase opacity-70 md:text-base">
                    Footprints
