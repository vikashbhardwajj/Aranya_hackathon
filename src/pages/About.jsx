...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>About Aranya – Our Origin & Purpose</title>
        <meta
          name="description"
          content="Discover the soulful journey behind Aranya. Born under the Banyan, rooted in reverence, built to celebrate Earth’s sacred gifts."
        />
        <meta
          name="keywords"
          content="About Aranya, nature journey, origin, Earth mission, Bloommark story"
        />
        <meta name="robots" content="index, follow" />

        <meta property="og:title" content="About Aranya – Rooted in Purpose" />
        <meta
          property="og:description"
          content="Born not in boardrooms, but beneath the banyan shade. Explore the origin of Aranya and its soulful mission."
        />
        <meta
          property="og:image"
          content="https://aranya-five.vercel.app/about-cover.jpg"
        />
        <meta
          property="og:url"
          content="https://aranya-five.vercel.app/about"
        />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About Aranya – Our Story" />
        <meta
          name="twitter:description"
          content="Rooted in reverence, Aranya is a poetic homage to the Earth’s gifts."
        />
        <meta
          name="twitter:image"
          content="https://aranya-five.vercel.app/about-cover.jpg"
      ...
      <PageWrapper className="about text-3xl">
        <div className="about_wrapper">
          ...
          <div className="about_page_2">
            <div className="top_section relative mb-[2rem] p-[1rem] md:p-[2rem]">
              ...
              <h3 className="first-h3 text-[1.5rem] md:text-[3rem] md:first-letter:ml-[7rem] lg:text-[4rem] lg:first-letter:ml-[17rem]">
                Aranya began as a whisper of longing—to reconnect with the
                Earth, to offer homage not in words, but in purpose. Each of our
                creations is a silent prayer to the planet we call home.
              </h3>
            </div>
            <div className="bottom_section relative p-[1rem] text-end md:p-[2rem]">
              <p className="mb-2 text-xl leading-none font-bold tracking-wider uppercase opacity-70 md:text-2xl">
                “Born not in pixels, but in petals — where creativity meets
                soil.”
              </p>
          ...
          <div className="about_page_3">
            <details
              className="about_details p-[1rem] md:p-[2rem]"
              open={false}
            >
              <summary className="">
                <h1 className="mb-2 text-[60px] -tracking-[5px] md:mb-7 md:text-[8rem] lg:text-[10rem] lg:-tracking-[9px]">
              ...
              <p className="mb-2 text-lg leading-none font-bold tracking-wider uppercase opacity-70 md:text-2xl">
                “Not manufactured — but manifested by the mountains and
                monsoon.”
              </p>
              ...
              <h3 className="text-[1.5rem] md:text-[3rem] lg:text-[3rem]">
                Aranya didn’t start as a business idea — it began as a feeling.
                A quiet reverence for dew-laced mornings, for rustling leaves
                that speak without sound. We grew from soil, sun, and spirit —
                and every creation is an ode to that sacred balance between
                nature and being.
              </h3>
            </details>
